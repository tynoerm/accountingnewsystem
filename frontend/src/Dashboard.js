    ...
    <div style={styles.container}>
      <nav className="navbar border-bottom shadow-lg p-3 mb-5 rounded" style={{ backgroundColor: "purple" }}>
                <div className="container-fluid">
                    <span className="navbar-brand text-white"><b>MAIN DASHBOARD</b></span>
                </div>
            </nav>
          ...
          <div className="col">
            <div className="card shadow-lg rounded">
              <div className="card-body">
                ...
                <p className="card-text">Handles financial management, accounting, and reporting.</p>
                <Link to="/Finance"  className="btn btn-primary">Next</Link>
              </div>
            </div>
          </div>
