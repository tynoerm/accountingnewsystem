...
const Quotation = () => {
    ...
    useEffect(() => {
        axios.get("https://localhost:3001/quotation")
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:3001/quotation/create-quote", quotationInsert)
            .then(() => {
    ...
    const handleQuoteChange = async (quoteId) => {
        try {
            ...
            await axios.put(`http://localhost:3001/quotation/update-status/${quoteId}`, { quoteStatus: newStatus });
    ...
    const handleDownload = async (type) => {
        try {
            const response = await axios.get(`http://localhost:3001/quotation/download/${type}`, { responseType: "blob" });
