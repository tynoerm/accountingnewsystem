...
const Dashboard = () => {
  ...
  <a style={{ color: 'white', fontSize: '1.5rem', fontWeight: 'bold', textDecoration: 'none' }}>SALES MODULE DASHBOARD</a>
  
  <Link to="/" style={{ background: 'white', color: 'purple', padding: '0.5rem 1rem', borderRadius: '4px', fontWeight: 'bold', textDecoration: 'none' }}>BACK</Link>
</nav>
